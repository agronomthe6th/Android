package ru.mirea.lazarev.yandexmaps;
...
public class yandexmaps extends AppCompatActivity implements UserLocationObjectListener {
    private MapView mapView;
    private final String MAPKIT_API_KEY = "e0baf2e4-b3e9-4eca-b155-72b3385501ff";
